...
class CommentServiceTest {
    ...
    void deleteShouldMarkDeletedIfHasChilderen() {
        // given
        Long articleId = 1L;
        Long commentId = 2L;
    ...
    private Comment createComment(Long articledId, Long  commentId) {
        Comment comment = mock(Comment.class);
        given(comment.getArticleId()).willReturn(articledId);
